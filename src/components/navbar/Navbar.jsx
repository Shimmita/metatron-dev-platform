      ...
      <MetatronToolBar>
        ...
        {!showMobileSearch && (
          ...
          >
            ...
            {CustomDeviceTablet() ? (
              <Box display={"flex"} alignItems={"center"} gap={1}>
                <Avatar alt="KE" src={AppLogo} sx={{ width: 38, height: 38 }} />
        ...
        >
                  ...
                  <TableRow>
                    <TableCell>
                      <Typography variant="body2">
                        <PersonRounded color={"primary"} /> Following
                      </Typography>{" "}
                    </TableCell>
                    <TableCell align="right">
                      <Typography className="ms-2" variant="body2">
                        <PeopleRounded color={"primary"} /> Followers
                      </Typography>{" "}
                    </TableCell>
                  </TableRow>
                </TableHead>
          ...
          <List>
            ...
            >
              ...
              <ListItemText
                primary={<Typography variant="body2">Account Menu</Typography>}
              />
            ...
            <ListItemButton onClick={(e) => setOpenEvents(!openEvents)}>
              ...
              <ListItemText
                primary={
                  <Typography variant="body2">Events and Courses</Typography>
                }
              />
